...
class EXU extends Module {
    ...
    io.out.bits.alu_res  := MuxCase(
        ...
        Seq(
            ...
            (io.in.bits.excode === ALU_MULH) -> ((io.in.bits.data1.asTypeOf(SInt(64.W)) * io.in.bits.data2.asTypeOf(SInt(64.W))) >> 32.U).asTypeOf(UInt(32.W)),
            (io.in.bits.excode === ALU_MULHU)-> ((io.in.bits.data1.asTypeOf(UInt(64.W)) * io.in.bits.data2.asTypeOf(UInt(64.W))) >> 32.U),
